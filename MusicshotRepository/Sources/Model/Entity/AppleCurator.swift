...
extension AppleCurator: EntityConvertible {
    typealias Impl = AppleCuratorImpl
...
final class AppleCuratorImpl: AppleCurator, EntityImplConvertible {
...
extension AppleCuratorImpl: CustomStringConvertible {
